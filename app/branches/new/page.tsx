...
export default function AddBranchPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        // Confirmation for setting inactive
        if (!formData.isActive) {
            if (!window.confirm('Are you sure you want to set this branch as Inactive? It will be hidden from the public website.')) {
                return
            }
        }
        ...
        setSubmitting(true)
        try {
            const result = await adminApi.createBranch(formData)
    ...
    return (
        <div className="container-custom py-12 fade-in">
            <div className="mb-8">
                <h1 className="mb-2">Add New Branch</h1>
